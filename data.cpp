...
short Data::operator[](int i) { return data_[i]; }

short Data::GetMin() { return min_; }

short Data::GetMax() { return max_; }

void Data::SetMin(short value) { min_ = value; }

void Data::SetMax(short value) { max_ = value; }

int Data::GetWidth() { return width_; }

int Data::GetHeight() { return height_; }

int Data::GetDepth() { return depth_; }
